#!/bin/bash
# One-shot launcher for the SAGE_MPPI tall-scene UR7e experiment.
# Default behavior:
...
log() {
    echo "[run_all_reach_static_tall_sage] $*" >&2
}
...
echo "============================================================"
echo "UR7e SAGE-MPPI Tall Scene - Unified Launcher"
echo "============================================================"
...
log "Gazebo is ready, starting SAGE controller"
