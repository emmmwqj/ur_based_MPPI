#!/bin/bash
# UR7e SAGE-MPPI Reach Static - Gazebo 高墙场景启动脚本
...
echo "=============================================="
echo "UR7e SAGE-MPPI Reach Static - Gazebo 高墙场景"
echo "=============================================="
...
echo "启动 SAGE-MPPI Reach Static 高墙场景控制器..."
echo ""
cd "$SCRIPT_DIR"
