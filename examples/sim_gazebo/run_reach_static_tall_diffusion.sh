#!/bin/bash
# UR7e Diffusion MPPI Reach Static - Gazebo 高墙场景启动脚本
...
echo "=============================================="
echo "UR7e Diffusion MPPI Reach Static - Gazebo 高墙场景"
echo "=============================================="
...
echo "启动 Diffusion Reach Static 高墙场景控制器..."
echo ""
cd "$SCRIPT_DIR"
...
python3 reach_static_ur7e_tall_diffusion.py "${PASS_ARGS[@]}"
