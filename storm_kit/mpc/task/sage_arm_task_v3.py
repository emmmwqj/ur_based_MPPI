...
from ..control.sage_mppi_core import SAGE_MPPI_CORE
...
class SageArmTaskV3(BaseTask):
    ...
    def init_sage_mppi(self, task_file, robot_file, world_file):
        ...
        return SAGE_MPPI_CORE(**controller_params)
    ...
    def _augment_task_stats(self, stats):
        ...
        stats["controller_type"] = "SAGE_MPPI_CORE"
